...
export default function Sale() {
 ...
 <main>
       ...
       <div className=" flex bg-slate-400  w-full  justify-between items-center">
        ...
        <li className="  font-sans text-black  m-2  bg-blue-500 pl-2 pr-2  rounded-t rounded-r rounded-b"><a href="/sale"  >SALE</a></li>
        </ul>
 ...
 <div className=" flex gap-x-7 mt-7  pl-5 ">
           ...
           <h1 className=" flex pl-6 "> $ :<h1 className="pl-1 flex">8,536.00</h1>
                <p className=" font-light  text-clip flex text-xs"><del className=" flex mt-1">11,536.00</del></p><a className="text-green-500">10%sale</a></h1>
       ...
       <div className="   w-72 h-96   px-1 py-1 rounded-r rounded-t rounded-b">
           ...
           <h1 className=" flex pl-6"> $ :<h1 className="pl-1 flex">5,336.00</h1>
                <p className=" font-light  text-clip flex text-xs mt-1 "><del className=" flex mt-1">11,536.00</del></p><a className="text-green-500">10%sale</a></h1>
